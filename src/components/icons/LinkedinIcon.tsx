const LinkedinIcon = () => {
    return <a className="bg-black border border-box border-cyan-900 hover:border-cyan-500 hover:bg-cyan-500/10 p-2 rounded-md cursor-pointer text-cyan-500 hover:text-white">
