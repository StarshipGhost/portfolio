...
const projects : ProjectCardProp[] = [
        ...
        },
        {
            ...
            technologies: ['React', 'Typescript', 'Python', 'scikit-learn', 'pandas', 'matplotlib', 'Fast API'],
            img: project_2
        },
        {
            ...
            technologies: ['React', 'Typescript', 'CSS', 'DofusDB API'],
            img: project_3
        },
    ...
    return (
        <div className='bg-black backdrop-blur-3xl border border-solid border-purple-500/30 hover:border-purple-400 rounded-xl'>
            ...
            <div className="flex flex-col gap-4 p-4">
                ...
                <p className='h-35 text-sm text-neutral-400 overflow-y-auto'>{description}</p>
                ...
                <div className='w-full grid grid-cols-1 md:grid-cols-2 gap-4'>
                    ...
                    <a href={repo} className='text-purple-400 hover:text-primary-foreground text-sm font-medium h-9 flex justify-center items-center gap-2 border border-solid border-purple-500/50 hover:border-purple-400 bg-accent-foreground hover:bg-purple-500/10 rounded-lg cursor-pointer'><GithubIcon /> Code </a>
                </div>
            </div>
        </div>
    )
