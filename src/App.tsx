...
function App() {
  return (
    <div className='min-w-80'> 
      ...
      <div className='fixed top-0 left-1/4 size-96 bg-cyan-500/20 blur-3xl rounded-full animate-pulse'></div>
      <div className='fixed bottom-0 right-1/4 size-96 bg-purple-500/20 blur-3xl rounded-full animate-pulse'></div>
      <Header/> 
      <Hero/>
